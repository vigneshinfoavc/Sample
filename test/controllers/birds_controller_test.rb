...
class BirdsControllerTest < ActionController::TestCase
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post :create, bird: { continents: @bird.continents, family: @bird.family, name: @bird.name, visible: @bird.visible }
    end
  ...
  test "should update bird" do
    patch :update, id: @bird, bird: { continents: @bird.continents, family: @bird.family, name: @bird.name, visible: @bird.visible }
    assert_redirected_to bird_path(assigns(:bird))
  end
